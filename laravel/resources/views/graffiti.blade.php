...
<html lang="es">
   <head>
      ...
      <title>Tour del Graffiti - Medellín</title>
   ...
   <body>
      ...
      <main>
         <section class= "contenedor graffiti">
            <h2 class="titulo">
            Tour del Graffiti - Medellín
            </h2>
            <!-- Estas son las caracteristicas del recorrido -->
            <div class="contenedor-graffiti">
               <img src="img/graffiti.jpg" alt="" class = "img-port-recor">
