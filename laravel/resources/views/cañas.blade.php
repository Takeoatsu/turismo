      ...
      <main>
         ...
         <section class="contenedor-form">
            ...
            <div class = "formu">
               ...
               <form action="/Cañas" method="POST" id="alojamiento" autocomplete = "off">
               ...
               @csrf
               <div class="info">
                  <p>Nombre del alojamiento: <input  type ="text" id ="id_nom" class ="form-control" readonly value = "Hotel las cañas"></p>
                  <p>Localidad del alojamiento: <input type ="text" name ="loc_alo" id ="id_loc" class ="form-control"readonly value = "Cañas Gordas"></p>
                  <p>Precio por día: <input type ="money" name ="pre_alo" id ="id_pre" class ="form-control"readonly value ="{{$Precio}}"></p>
               </div>
               <div class="reser">
                ...
                <div class="opt_ext-select">
                  ...
                  <!--<input type="button" name ="btnRegistrar" id = "btnRegistrar" value="Registrar reserva"
                     onclick = "" >-->
                  <button class="btn btn-success float-right" name ="btnRegistrar" id = "btnRegistrar" type="Submit">Registrar reserva</button>
